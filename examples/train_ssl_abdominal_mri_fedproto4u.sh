...
#CPT="myexperiments-fedproto"
CPT="myexperiments-fedproto-s1"
#CPT="myexperiments"
...
#python /data1/wjp/Fed_fewshot_proto/Fedproto_training_mri4u.py with \
python /date/wjp/Fed_fewshot_proto/Fedproto_training_mri4u.py with \
