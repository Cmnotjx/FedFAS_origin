...
#CPT="myexp_fedproto"
CPT="myexp_fedproto_s1_"
#CPT="myexp"
DATASET='SABS'
NWORKER=4
ROUND=5
ALL_EV=( 0 2 4 6 8) # 5-fold cross validation (0, 2, 4, 6, 8)
...
#LABEL_SETS=4CT_contrasCL
#LABEL_SETS=1
#EXCLU='[1,6]'

###### Training configs ######
NSTEP=4000 #[1000,2000,4000]
DECAY=0.95
...
do
    ...
    do
    PREFIX="train_${DATASET}_scale_${SUPERPIX_SCALE}_vfold${EVAL_FOLD}"
    echo $PREFIX
...
#python /data1/wjp/Fed_fewshot_proto/Fedproto_training_ct4u.py with \
python /home/b311/data1/wjp/Fed_fewshot_proto/Fedproto_training_ct4u.py with \
