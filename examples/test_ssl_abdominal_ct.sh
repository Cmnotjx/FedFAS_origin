...
ALL_EV=(0 2 4 6 8) # 5-fold cross validation (0, 1, 2, 3, 4)
...
###### Validation configs ######
SUPP_ID='[2]' # using the additionally loaded scan as support
...
#    python3 /date/wjp/Fed_fewshot_proto/validation_exp_ct.py with \
python3 /home/b311/data1/wjp/Fed_fewshot_proto/validation_exp_ct.py with \
