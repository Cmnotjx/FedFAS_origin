...
class SuperpixelDataset(BaseDataset):
    def __init__(self, which_dataset, base_dir, idx_split, mode, transforms, scan_per_load, num_rep = 2, min_fg = '', nsup = 1, fix_length = None, client_splite = None,tile_z_dim = 3, exclude_list = [], superpix_scale = 'SMALL', **kwargs):
        """
        Pseudolabel dataset
        Args:
        ...
        self.scan_ids = self.get_scanids(mode, idx_split, client_splite) # patient ids of the entire fold
    ...
    '''dataset_splite'''
    def get_scanids(self, mode, idx_split, client_splite):
        val_ids = copy.deepcopy(self.img_pids[self.sep[idx_split]: self.sep[idx_split + 1] + self.nsup])
        if mode == 'train':
            train_all = [ii for ii in self.img_pids if ii not in val_ids]
            # print(train_all, "train_all_idx") ['10', '13', '15', '19', '20', '21', '22', '31', '32', '33', '34', '36', '37', '38', '39'] train_all_idx
            '''ABD-MRI-TRAIN'''
            if client_splite == 'CHAOST2_Superpix_1':
                client_idx = train_all[0:3]
            elif client_splite == 'CHAOST2_Superpix_2':
                client_idx = train_all[3:7]
            elif client_splite == 'CHAOST2_Superpix_3':
                client_idx = train_all[7:11]
            elif client_splite == 'CHAOST2_Superpix_4':
                client_idx = train_all[11:15]

            '''ABD-CT-TRAIN'''
            if client_splite == 'SABS_Superpix_1':
                client_idx = train_all[0:6]
            elif client_splite == 'SABS_Superpix_2':
                client_idx = train_all[6:11]
            elif client_splite == 'SABS_Superpix_3':
                client_idx = train_all[11:16]
            elif client_splite == 'SABS_Superpix_4':
                client_idx = train_all[16:21]

            '''CMR-CO-TRAIN'''
            if client_splite == 'C0_Superpix_1':
                client_idx = train_all[0:8]
            elif client_splite == 'C0_Superpix_2':
                client_idx = train_all[8:16]
            elif client_splite == 'C0_Superpix_3':
                client_idx = train_all[16:23]
            elif client_splite == 'C0_Superpix_4':
                # client_idx = train_all[17:22]
                pass
            ...
            '''ABD-MRI-TEST'''
            if client_splite == 'CHAOST2_Superpix_1':
                client_val_ids = val_ids[0]
            elif client_splite == 'CHAOST2_Superpix_2':
                client_val_ids = val_ids[1]
            elif client_splite == 'CHAOST2_Superpix_3':
                client_val_ids = val_ids[2]
            elif client_splite == 'CHAOST2_Superpix_4':
                client_val_ids = val_ids[3]

            '''ABD-CT-TEST'''
            if client_splite == 'SABS_Superpix_1':
                client_val_ids = val_ids[0:2]
            elif client_splite == 'SABS_Superpix_2':
                client_val_ids = val_ids[2:4]
            elif client_splite == 'SABS_Superpix_3':
                client_val_ids = val_ids[4:6]
            elif client_splite == 'SABS_Superpix_4':
                client_val_ids = val_ids[6:8]

            '''ABD-CT-TEST'''
            if client_splite == 'C0_Superpix__1':
                client_val_ids = val_ids[0:2]
            elif client_splite == 'C0_Superpix__2':
                client_val_ids = val_ids[2:4]
            elif client_splite == 'C0_Superpix__3':
                client_val_ids = val_ids[4:6]
            elif client_splite == 'C0_Superpix__4':
                # client_val_ids = val_ids[6:8]
                pass

            return client_val_ids
    ...
    def __len__(self):
        ...
        """
        # print(len(self.actual_dataset),"datasets of length")
